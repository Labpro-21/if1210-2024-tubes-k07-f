...
def SHOP (currentUser, mShop, iShop, mons) :
    aksi = "lihat"
    shopCount = 0
    msTemp = []
    isTemp = []
            ...
            if beli == "monster" :
                ...
                if id_monster > (len(mShop)-1) : 
                    ...
                    if mShop [id_monster][1] == 0 :
                        ...
                        mons_to_inv.append ([currentUser [0], mons[int(mShop[id_monster][0])][0], 1])
                ...
                if id_potion > len(iShop)-1 : 
                    ...
                    if int(iShop [id_potion][1]) < jumlah_potion :
                        ...
                        item_to_inv.append ([currentUser[0], iShop [id_potion][0], jumlah_potion])
